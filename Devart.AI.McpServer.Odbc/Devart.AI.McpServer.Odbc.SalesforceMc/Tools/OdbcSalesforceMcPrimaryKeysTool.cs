// --------------------------------------------------------------------------
// <copyright file="OdbcSalesforceMcPrimaryKeysTool.cs" company="Devart">
//
...
{
  internal sealed class OdbcSalesforceMcPrimaryKeysTool(McpConfiguration serverConfiguration) : PrimaryKeysTool(serverConfiguration)
  {
